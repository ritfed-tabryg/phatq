...
(declare-fun op_a ((_ BitVec 64) (_ BitVec 64)) (_ BitVec 64))
(declare-fun op_b ((_ BitVec 64) (_ BitVec 64)) (_ BitVec 64))
(declare-fun op_c ((_ BitVec 64) (_ BitVec 64)) (_ BitVec 64))
(declare-fun op_d ((_ BitVec 64) (_ BitVec 64)) (_ BitVec 64))
(declare-fun op_e ((_ BitVec 64) (_ BitVec 64)) (_ BitVec 64))
(declare-fun op_f ((_ BitVec 64) (_ BitVec 64)) (_ BitVec 64))
(declare-fun op_g ((_ BitVec 64) (_ BitVec 64)) (_ BitVec 64))
(declare-fun op_h ((_ BitVec 64) (_ BitVec 64)) (_ BitVec 64))
(declare-fun op_combine (
...
(define-fun hash ((name (_ BitVec 64))) (_ BitVec 16)
    ((_ extract 15 0) (op_combine
        ; TODO: use bitwise and instead of extract & concat?
        (op_a a (concat #x00000000000000 ((_ extract 7 0) name)))
        (op_b b (concat #x00000000000000 ((_ extract 15 8) name)))
        (op_c c (concat #x00000000000000 ((_ extract 23 16) name)))
        (op_d d (concat #x00000000000000 ((_ extract 31 24) name)))
        (op_e e (concat #x00000000000000 ((_ extract 39 32) name)))
        (op_f f (concat #x00000000000000 ((_ extract 47 40) name)))
        (op_g g (concat #x00000000000000 ((_ extract 55 48) name)))
        (op_h h (concat #x00000000000000 ((_ extract 63 56) name)))
        x
    ))
)
